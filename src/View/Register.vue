  ...
  <v-container>
    <v-row align="center" justify="center" dense>
      <v-col cols="12" sm="8" md="4" lg="4">
        <v-card elevation="12" max-width="500">
          <v-card-text>
            <v-form>
              <v-text-field
                ...
                outlined
              ></v-text-field>
              <!-- <v-text-field label="Enter your Last Name" name="lname" prepend-inner-icon="mdi-account" type="text" class="rounded-0" outlined></v-text-field> -->
              <v-text-field
              ...
              <v-btn class="rounded-0" color="#EF6C00" x-large block dark
                >Register</v-btn
              >
          ...
          <v-card-actions class="ml-6 mr-6 text-center">
            <p>
              By continuing, you agree to Ceylon Electricity Board
